...
| [**The Human Protein Atlas**](https://www.proteinatlas.org/)                        | an open-access resource for human proteins; includes: <ul><li>protein expression and localization in tissue</li><li>protein subcellular location</li><li>bulk and single-cell RNA expression in tissue</li><li>RNA expression in cell lines</li><li>blood protein level</li></ul> |
| [**The Genotype-Tissue Expression (GTEx) Portal**](https://www.gtexportal.org/home) | a comprehensive public resource for researchers studying tissue and cell-specific gene expression and regulation across individuals, development, and species (NIH)                                                                                                               |
...
| [**Online Mendelian Inheritance in Man (OMIM)**](https://www.omim.org/)             | a catalog of human genes and genetic disorders and traits, with particular focus on the molecular relationship between genetic variation and phenotypic expression                                                                                                                |
